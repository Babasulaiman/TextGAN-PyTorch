...
dataset = 'sample'  # oracle, image_coco, emnlp_news, amazon_app_book, amazon_app_movie, mr15
...
max_seq_len = 115  # oracle: 20, coco: 37, emnlp: 51, amazon_app_book: 40
...
# ===Basic Train===
samples_num = 35  # 10000, mr15: 2000
MLE_train_epoch = 30  # SeqGAN-80, LeakGAN-8, RelGAN-150
PRE_clas_epoch = 10
